...
# Load all targets data directly (no RDS files)
targets::tar_load(c(
  full_data,
  missing_data_grid,
  analysis_data,
...
Wind speed colored by [Beaufort scale](https://en.wikipedia.org/wiki/Beaufort_scale) category.
...
| **GPD** | [Generalized Pareto](https://en.wikipedia.org/wiki/Generalized_Pareto_distribution) distribution |
...
|--------|-------------|----------|
| **GEV** | Block maxima approach | Annual maxima |
| **GPD** | Peaks over threshold | Per-station extremes |
