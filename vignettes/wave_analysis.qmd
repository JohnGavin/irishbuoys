...
# Load all targets data and pre-computed plots
targets::tar_load(c(
  # Data
  full_data,
  missing_data_grid,
  ...
  # Pre-computed plots (just print these - no computation in vignette)
  plot_rogue_all,
...
```{r rogue-gusts-all}
# Pre-computed plot - just print
targets::tar_load(plot_rogue_gusts_all)
...
#| fig-height: 14
# Pre-computed plot - just print
targets::tar_load(plot_rogue_gusts_by_station)
...
targets::tar_load(plot_gusts_vs_waves)
plot_gusts_vs_waves
```
