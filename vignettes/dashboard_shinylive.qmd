...
server <- function(input, output, session) {
  ...
  output$last_updated <- renderText({
    ...
    paste0(
      ...
      "Max Hs in dataset: ", round(max(data$wave_height, na.rm = TRUE), 1), "m (historical max ~15m Hs)\n",
      "Max Hmax in dataset: ", round(max(data$hmax, na.rm = TRUE), 1), "m (historical max ~23m individual wave)\n",
      "Max Hmax/Hs ratio: ", round(max(data$hmax/data$wave_height, na.rm = TRUE), 2), " (>2.0 = rogue wave)\n",
