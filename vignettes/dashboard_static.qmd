...
ggplot(buoy_data, aes(x = wind_speed, y = wave_height, color = station_id)) +
  ...
  labs(title = "Wind Speed vs Wave Height", x = "Wind Speed (knots)", y = "Wave Height (m)", color = "Station") +
...
```{r}
#| fig-width: 12
ggplot(get_station_data(buoy_data, "M2"), aes(x = wind_speed, y = wave_height)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_smooth(method = "lm", se = TRUE, color = "red") +
  labs(title = "Wind vs Wave - M2", x = "Wind Speed (knots)", y = "Wave Height (m)") + theme_minimal()
```
...
```{r}
#| fig-width: 12
ggplot(get_station_data(buoy_data, "M3"), aes(x = wind_speed, y = wave_height)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_smooth(method = "lm", se = TRUE, color = "red") +
  labs(title = "Wind vs Wave - M3", x = "Wind Speed (knots)", y = "Wave Height (m)") + theme_minimal()
```
...
```{r}
#| fig-width: 12
ggplot(get_station_data(buoy_data, "M4"), aes(x = wind_speed, y = wave_height)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_smooth(method = "lm", se = TRUE, color = "red") +
  labs(title = "Wind vs Wave - M4", x = "Wind Speed (knots)", y = "Wave Height (m)") + theme_minimal()
```
...
```{r}
#| fig-width: 12
ggplot(get_station_data(buoy_data, "M5"), aes(x = wind_speed, y = wave_height)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_smooth(method = "lm", se = TRUE, color = "red") +
  labs(title = "Wind vs Wave - M5", x = "Wind Speed (knots)", y = "Wave Height (m)") + theme_minimal()
```
...
```{r}
#| fig-width: 12
ggplot(get_station_data(buoy_data, "M6"), aes(x = wind_speed, y = wave_height)) +
  geom_point(alpha = 0.4, color = "steelblue") +
  geom_smooth(method = "lm", se = TRUE, color = "red") +
  labs(title = "Wind vs Wave - M6", x = "Wind Speed (knots)", y = "Wave Height (m)") + theme_minimal()
```
