...
create_storm_alert_email <- function(storm_events,
  ...
  email_body <- paste0(
    ...
    "<a href='https://johngavin.github.io/irishbuoys/articles/dashboard_static.html' style='color:#ffcdd2;'>Dashboard</a>",
    " | <a href='https://johngavin.github.io/irishbuoys/articles/wave_analysis.html#rogue-waves' style='color:#ffcdd2;'>Rogue Waves</a>",
