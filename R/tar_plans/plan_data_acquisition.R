...
plan_data_acquisition <- list(
  ...
  targets::tar_target(
    ...
    irishbuoys::get_latest_timestamp()
  ),

  # Get current database statistics
  targets::tar_target(
    current_db_stats,
    irishbuoys::get_database_stats()
  ),

  # Perform incremental update if needed
  targets::tar_target(
    data_update,
    irishbuoys::incremental_update(lookback_hours = 48)
  ),

  # Download specific date range for analysis
  targets::tar_target(
    recent_data,
    irishbuoys::download_buoy_data(
