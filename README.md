...
Interactive validation reports generated by the
[pointblank](https://rstudio.github.io/pointblank/) package:

- **[Analysis Data
  Validation](https://johngavin.github.io/irishbuoys/articles/validation_analysis_data.html)**:
  Comprehensive checks on buoy data including column existence, physical
  bounds (wave height 0-30m, wind speed 0-100 m/s), and station ID
  validation
- **[Rogue Wave
  Validation](https://johngavin.github.io/irishbuoys/articles/validation_rogue_events.html)**:
  Event-level validation ensuring detected rogue waves meet the Hmax \>
  2 x Hs criterion
- **Interactive reports**: Each report shows pass/fail status with
  detailed interrogation results
...
------------------------------------------------------------------------
    ...
    *Last updated: 2026-02-13 12:25 UTC *
