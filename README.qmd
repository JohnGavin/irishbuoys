...
The `irishbuoys` package provides tools to download, process, and analyze data from the [Irish Weather Buoy Network](https://www.marine.ie/site-area/data-services/real-time-observations/irish-weather-buoy-network). It includes functions for accessing real-time and historical data via the Marine Institute's ERDDAP server, storing data in DuckDB for efficient querying, and building predictive models for wave height and weather conditions.

> **Disclaimer:** `irishbuoys` is an independent open-source project. It is not affiliated with, endorsed by, or part of the [Marine Institute](https://www.marine.ie/) or the Irish Weather Buoy Network. Buoy observation data is sourced from the Marine Institute's publicly available [ERDDAP server](https://erddap.marine.ie/erddap/). Wind forecasts used in storm alerts come from [Open-Meteo](https://open-meteo.com/). For official marine weather warnings, consult [Met Eireann](https://www.met.ie/warnings).
...
Install from [r-universe](https://johngavin.r-universe.dev/irishbuoys) — no compilation needed, binary packages available:
...
<details>
<summary>Entering and verifying pure mode</summary>
...
Comprehensive vignettes on the [package website](https://johngavin.github.io/irishbuoys/):

::: {.panel-tabset}

### Dashboards

**[Static Dashboard](https://johngavin.github.io/irishbuoys/articles/dashboard_static.html)** - Interactive visualization of Irish Weather Buoy Network data.
...
- **Extreme event detection**: Rogue wave identification (Max Wave > 2× Signif Wave)

### Analysis

**[Wave Analysis](https://johngavin.github.io/irishbuoys/articles/wave_analysis.html)** - Scientific analysis of wave patterns and extreme value statistics.
...
Interactive validation reports via [pointblank](https://rstudio.github.io/pointblank/):

- **[Analysis Data Validation](https://johngavin.github.io/irishbuoys/articles/validation_analysis_data.html)**: Column checks, physical bounds (wave 0-30m, wind 0-100 m/s)
- **[Rogue Wave Validation](https://johngavin.github.io/irishbuoys/articles/validation_rogue_events.html)**: Ensures Hmax > 2 × Hs criterion

### Telemetry

**[Pipeline Telemetry](https://johngavin.github.io/irishbuoys/articles/telemetry.html)** - Pipeline metrics and performance tracking.
...
<details>
<summary><strong>Contributing, License & Acknowledgments</strong></summary>

**Contributing**: Contributions are welcome! Please feel free to submit a Pull Request.

**License**: MIT License. See LICENSE file for details.

**Acknowledgments**: Data provided by the Marine Institute Ireland in collaboration with Met Éireann and the UK Met Office.
